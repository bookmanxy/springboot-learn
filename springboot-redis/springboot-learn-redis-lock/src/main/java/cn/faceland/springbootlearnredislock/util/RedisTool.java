package cn.faceland.springbootlearnredislock.util;

import redis.clients.jedis.Jedis;

/**
 * @author watermelon on 2019/10/28 13:29
 * @description 参考：https://mp.weixin.qq.com/s/iOtnIEPlEM1crBIgHXDZsg
 */
public class RedisTool {
     ...
     * @param expireTime 超期时间  -- ms（毫秒）为单位
     * @return 是否获取成功
     */
     ...
     * @param requestId
     */
    public static void tryReleaseLock(Jedis jedis, String lockKey, String requestId) {
