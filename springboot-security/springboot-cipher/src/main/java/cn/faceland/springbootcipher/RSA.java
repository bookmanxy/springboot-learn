package cn.faceland.springbootcipher;
...
public class RSA {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KeyPair keyPair = RSA.getKeyPair("faceland");
        //公钥
        String publicKey = RSA.getPublicKey(keyPair);
//        String publicKey = "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAKdpMOFO2A3YePWsDFFOBL5o6BYQFfkUYJlPfI3URMAwuX5a2bPEVbs7ZA1xtHm+Lt774sNQ/5Qd+oqUGekF9G0CAwEAAQ==";

        //私钥
        String privateKey = RSA.getPrivateKey(keyPair);
//        String privateKey = "";
