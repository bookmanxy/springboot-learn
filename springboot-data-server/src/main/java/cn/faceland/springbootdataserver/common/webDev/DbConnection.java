package cn.faceland.springbootdataserver.common.webDev;

import cn.faceland.springbootdataserver.common.DataConstants;
import cn.faceland.springbootdataserver.common.utils.SpringContextUtils;
...
public class DbConnection {
  ...
  public Connection getConnection() {
    ...
    try {
      DruidDataSource dataSource = (DruidDataSource) SpringContextUtils.getBean(DataConstants.DATASOURCE_BEAN_NAME);
